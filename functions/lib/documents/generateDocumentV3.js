...
exports.generateDocumentV3 = void 0;
const https_1 = require("firebase-functions/v2/https");
const firebaseAdmin_1 = require("../config/firebaseAdmin");
const templateResolver_1 = require("../services/templateResolver");
const googleDocEngine_1 = require("../services/googleDocEngine");
 ...
 */
function buildOfferPlaceholderDictionary(payload) {
 ...
 */
exports.generateDocumentV3 = (0, https_1.onCall)({
    cors: true,
}, async (request) => {
    ...
    if (!isAuthDisabled) {
        if (!request.auth) {
            throw new https_1.HttpsError('unauthenticated', 'Firebase authentication required.');
        }
        const authenticatedEmployeeId = request.auth.uid;
        const employeeQuery = await firebaseAdmin_1.adminDb
    ...
    try {
        ...
        const resolved = await templateResolver_1.TemplateResolver.resolveTemplate(payload.documentType, payload.brandId);
        ...
        const result = await googleDocEngine_1.GoogleDocEngine.generateDocumentPDF({
            templateId,
            folderId,
...
//# sourceMappingURL=generateDocumentV3.js.map