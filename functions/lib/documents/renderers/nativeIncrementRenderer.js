...
exports.compileIncrementLetterHTML = compileIncrementLetterHTML;
 ...
 */
function compileIncrementLetterHTML(options) {
    ...
    for (const block of blocks) {
      ...
      `;
            ...
            if (sigSrc && specificSignatures[sigSrc]) {
                ...
                sigUrl = sigObj.signatureUrl || sigObj.url || defaultSignatureUrl;
                sigName = sigObj.fullName || sigObj.name || defaultSignatoryName;
...
//# sourceMappingURL=nativeIncrementRenderer.js.map