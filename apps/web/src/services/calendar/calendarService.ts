...
class CalendarService {
   ...
   */
  async getEvents(role?: RoleItem | string, userId?: string): Promise<CalendarEventItem[]> {
  ...
  async saveEvent(
    ...
    if (!permissionService.isSuperAdmin(activeRole) && eventData.visibility === 'Organization') {
