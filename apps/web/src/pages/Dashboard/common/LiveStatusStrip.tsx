    ...
    <div className="bg-slate-900 text-slate-300 rounded-2xl p-3 px-5 border border-slate-800 flex items-center justify-between overflow-x-auto text-xs font-mono shadow-md">
      <div className="flex items-center gap-6 shrink-0">
        <div className="flex items-center gap-2">
          ...
          <span>Working Today: <strong className="text-white">128</strong></span>
        </div>
        <div className="flex items-center gap-2">
          <CalendarCheck size={14} className="text-teal-400" />
          <span>Present: <strong className="text-emerald-400">118</strong></span>
        </div>
        <div className="flex items-center gap-2">
          <CalendarOff size={14} className="text-amber-400" />
          <span>On Leave: <strong className="text-amber-300">10</strong></span>
        </div>
        <div className="flex items-center gap-2">
          <Video size={14} className="text-cyan-400" />
          <span>Meetings Today: <strong className="text-white">6</strong></span>
        </div>
        <div className="flex items-center gap-2">
          <Gift size={14} className="text-rose-400" />
          <span>Birthdays: <strong className="text-rose-300">2</strong></span>
        </div>
        <div className="flex items-center gap-2">
          <CheckCircle2 size={14} className="text-indigo-400" />
          <span>Pending Approvals: <strong className="text-amber-400">4</strong></span>
        </div>
      </div>
